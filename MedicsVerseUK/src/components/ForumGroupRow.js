        ...
        <div class="node node--id3 node--depth2 node--forum node--unread">
            <div class="node-body">
                ...
                <div class="node-main js-nodeMain">
                    <h3 class="node-title">
                        <a href={"/forum/"+props.data.name} data-xf-init="element-tooltip"
                            data-shortcut="node-description">{props.data.name}</a>
                    </h3>
                    <div class="node-meta">
                ...
                <div class="node-stats">
                    <dl class="pairs pairs--rows">
                        <dt>Threads</dt>
                        <dd>{props.data.Threads}</dd>
                    </dl>
                    <dl class="pairs pairs--rows">
                        <dt>Messages</dt>
                        <dd>{props.data.Messages}</dd>
                    </dl>
                    <dl class="pairs pairs--rows">
                        <dt>Views</dt>
                        <dd>{props.data.Views}</dd>
                    </dl>
                </div>
